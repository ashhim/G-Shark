...
const char D_APST_MONITOR[] PROGMEM = "APST MONITOR";
...
const char D_NAMEME[] PROGMEM = "FISH";
const char D_CAPAD[] PROGMEM = "CAPAD";
...
const char A_CAPAD_NO_AP_ERROR[] PROGMEM = "WARNING: CAPAD requires at least one selected access point";
const char A_NAMEME_NO_AP_ERROR[] PROGMEM = "WARNING: FISH requires at least one selected access point";
