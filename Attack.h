...
class Attack {
    public:
        ...
        void start(bool beacon, bool deauth, bool deauthAll, bool probe, bool capad, bool output, uint32_t timeout);
        void start(bool beacon, bool deauth, bool deauthAll, bool probe, bool capad, bool nameme, bool output, uint32_t timeout);
        void stop();
        void update();
    ...
    private:
        ...
        void beaconUpdate();
        void probeUpdate();
        uint16_t getCloneTargetCount();
        int getSelectedAPIndex(uint16_t selectedTarget);
        int getPrimaryCapadAP();
